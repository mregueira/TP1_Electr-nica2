...
\trabajo{FUENTE REGULADA DE TENSI\'ON}
\titulo{Trabajo de Laboratorio n^{\circ} 1}
\fecha{25 de Abril 2019} %Aca va la fecha. Si lo dejan asi muestra la fecha de compilacion.
\grupo{2}
